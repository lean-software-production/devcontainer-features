...
Installs the Claude Code coding-agent CLI globally. Requires Node.js 22+ and npm supplied by the base image or another feature.
...
|-----|-----|-----|-----|
| version | Claude Code npm version to install. 'latest' is the rolling default; use an exact version for reproducible containers. | string | latest |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/lean-software-production/devcontainer-features/blob/main/src/claude-code/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
